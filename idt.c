...
void idt_init(void){
	...
	idt_set_gate(20, (uint32_t)isr21, 0x08, 0x8E);
	idt_set_gate(21, (uint32_t)isr22, 0x08, 0x8E);
	idt_set_gate(22, (uint32_t)isr23, 0x08, 0x8E);
	idt_set_gate(23, (uint32_t)isr24, 0x08, 0x8E);
	idt_set_gate(24, (uint32_t)isr25, 0x08, 0x8E);
	idt_set_gate(25, (uint32_t)isr26, 0x08, 0x8E);
	idt_set_gate(26, (uint32_t)isr27, 0x08, 0x8E);
	idt_set_gate(27, (uint32_t)isr28, 0x08, 0x8E);
	idt_set_gate(28, (uint32_t)isr29, 0x08, 0x8E);
	idt_set_gate(29, (uint32_t)isr30, 0x08, 0x8E);
	idt_set_gate(30, (uint32_t)isr31, 0x08, 0x8E);
	idt_set_gate(31, (uint32_t)isr32, 0x08, 0x8E);
	idt_set_gate(32, (uint32_t)isr33, 0x08, 0x8E);
	idt_set_gate(33, (uint32_t)isr34, 0x08, 0x8E);
	idt_set_gate(34, (uint32_t)isr35, 0x08, 0x8E);
	idt_set_gate(35, (uint32_t)isr36, 0x08, 0x8E);
	idt_set_gate(36, (uint32_t)isr37, 0x08, 0x8E);
	idt_set_gate(37, (uint32_t)isr38, 0x08, 0x8E);
	idt_set_gate(38, (uint32_t)isr39, 0x08, 0x8E);
	idt_set_gate(39, (uint32_t)isr40, 0x08, 0x8E);
	idt_set_gate(40, (uint32_t)isr41, 0x08, 0x8E);
	idt_set_gate(41, (uint32_t)isr42, 0x08, 0x8E);
	idt_set_gate(42, (uint32_t)isr43, 0x08, 0x8E);
	idt_set_gate(43, (uint32_t)isr44, 0x08, 0x8E);
	idt_set_gate(44, (uint32_t)isr45, 0x08, 0x8E);
	idt_set_gate(45, (uint32_t)isr46, 0x08, 0x8E);
